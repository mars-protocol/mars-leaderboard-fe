...
// Scattered positions (floating state) - relative to center (250, 250)
// More spread out to avoid overlap
  ...
  return (
    <section id='hero' className='relative overflow-hidden'>
      <div className='relative h-full w-full min-h-[400px] md:min-h-[450px] pb-8'>
        <div className='z-10 container flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12 max-w-screen-xl mx-auto px-4 relative'>
          {/* Left Column - Text Content */}
          <div className='flex flex-col gap-4 pt-12 text-left w-full lg:w-1/2 lg:max-w-2xl'>
            <div>
              <motion.h1
                ref={fadeInRef}
          ...
          <div className='relative w-full lg:w-1/2 flex items-center justify-center lg:justify-end mt-16'>
            ...
            >
              ...
              <motion.div
                className='relative w-[280px] h-[280px] md:w-[400px] md:h-[400px] lg:w-[480px] lg:h-[480px]'
                style={{
                  filter: isHovered
                  ...
                  isHovered
                    ...
                    : {
                        rotate: {
                          ...
                          repeat: Infinity,
                          ease: 'linear',
                          delay: 1.5, // Start rotating after scattering begins
                        },
                      }
                }
              >
                ...
                >
                  ...
                  {/* Render each triangle with individual animations */}
                  {triangles.map((triangle, index) => {
                    ...
                    // Original position: triangle center is at (centerX, centerY)
                    // Scattered position: we want it at (svgCenter + scattered.x, svgCenter + scattered.y)
                    // Transform = target - current = (svgCenter + scattered.x) - centerX
                    const scatteredX = svgCenter + scattered.x - centerX
                    const scatteredY = svgCenter + scattered.y - centerY
                        ...
                        transition={
                          isHovered
                            ...
                            : {
                                ...
                                stiffness: 100,
                                mass: 1,
                                delay: 0.8 + index * 0.1, // Stagger the scattering
                              }
                        }
                      >
                        {/* Floating animation wrapper for scattered state */}
                        <motion.g
                          initial={{
                            x: 0,
                            y: 0,
                          ...
                          transition={
                            isHovered
                              ...
                              : {
                                  ...
                                  repeat: Infinity,
                                  ease: 'easeInOut',
                                  delay: 1.2 + index * 0.1, // Start floating after scattering
                                }
                          }
                        >
                          <motion.polygon
                            ...
                            animate={{
                              strokeWidth: isHovered || !iconInView ? 0 : 6,
                            }}
                            transition={{
                              duration: 0.3,
                              delay: 1.0 + index * 0.1, // Show border as they scatter
                            }}
                          />
                        </motion.g>
                      </motion.g>
                  ...
                  {/* White contour - visible when assembled */}
                  <motion.path
                    id='White-contour'
                    ...
                    animate={{
                      opacity: isHovered ? 1 : iconInView ? 0 : 1,
                    }}
                    transition={{
                      duration: 0.3,
                      delay: isHovered ? 0.2 : iconInView ? 0.8 : 0,
                    }}
                  />
                </svg>
              </motion.div>
            ...
            <div className='absolute inset-0 z-0 flex items-center justify-center pointer-events-none overflow-hidden opacity-30'>
              ...
              >
                {/* Background animation - matches Option 1 (CURRENT) */}
                <motion.div
                  animate={{
                    y: [0, -30, 0],
                    rotate: [0, -8, 8, 0],
